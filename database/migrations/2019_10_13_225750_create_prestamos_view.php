...
class CreatePrestamosView extends Migration
{
    ...
    public function up()
    {
        ...
        //     JOIN "estadoPrestamo" ep ON p."ID_ESTADO_PRESTAMO" = ep."ID_ESTADO_PRESTAMO"
        //     JOIN "materialBibliotecario" mb ON p."ID_MATERIAL" = mb.id
        //     JOIN "Ejemplar" e ON mb."ID_EJEMPLAR" = e.id;
        // ');

        //ESTE ERA EL ANTERIOR PERO ME DIO ERRORES Y EL DE ARRIBA ESTA CORREGIDO
        DB::statement('
            CREATE OR REPLACE VIEW public.vwprestamos
            AS SELECT p.id,
                p."FECHA_PRESTAMO",
