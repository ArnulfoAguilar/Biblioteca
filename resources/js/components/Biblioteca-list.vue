<template>
    <div class="container-fluid">
        <div class="row justify-content-center">
                    ...
                    <div class="card-body">
                        <form @submit.prevent="editarBiblioteca(Biblioteca)" v-if="modoEditar">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="Biblioteca.BIBLIOTECA" class="form-control" id="NOMBRE"
            ...
            <div class="col-md-8 col sm-12" style="overflow: auto; height:600px; ">
                <div class="card">
                        ...
                        <ul class="list-group">
                            ...
                            <p>
                                ...
                                <button class="btn btn-danger btn-sm" 
                                    @click="eliminarBiblioteca(item, index)">Eliminar</button>
                            </p>
                            </li>
                        </ul>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            agregar() {
                ...
                axios.post('/Biblioteca', bibliotecaNueva)
                    .then((response) =>{
            ...
            axios.put(`/Biblioteca/${BIBLIOTECA.id}`, parametros)
                .then(response=>{
            ...
            eliminarBiblioteca(Biblioteca, index){
                const confirmacion = confirm(`¿Eliminar Biblioteca ${Biblioteca.BIBLIOTECA}?`);
                if(confirmacion){
