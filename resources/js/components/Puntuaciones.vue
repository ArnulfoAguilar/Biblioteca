...
export default {
    data(){
        return {
            ...
            puntuaciones: [],
            modoEditar: false,
            Puntuacion: { id:'', PUNTUACION: '', VALOR:''},

            isEditing: false,
            createTitle: 'Agregar Puntuación',
            editTitle: 'Editar Puntuación',
            titleToShow: '',
            hasError: false
        }
    },
    ...
    methods:{
        sendData(){
            ...
            axios.get('/Puntuaciones').then(res=>{
                this.puntuaciones = res.data;
                this.eventFromApp = {
                    name: 'sendData',
                    payload: this.puntuaciones
                };
            this.triggerEvent();
        ...
        processEventFromApp(componentState){
            if(componentState.lastAction === 'Refresh'){
                axios.get('/Puntuaciones').then((result)=>{
            ...
            if (componentState.lastAction ==='DeleteItem') {
                this.EliminarPuntuacion(componentState.selectedItem, componentState.selectedIndex);
            }
        },
        ...
        guardar() {
            ...
            if(this.isEditing)
                ...
                axios.post('/Puntuaciones', puntuacionSave).then((res) =>{
                    this.success(msg);
                });
        ...
        this.Puntuacion.PUNTUACION = item.PUNTUACION;
        this.Puntuacion.id = item.id;
        this.Puntuacion.VALOR = item.VALOR;
        this.isEditing = true;
        },
