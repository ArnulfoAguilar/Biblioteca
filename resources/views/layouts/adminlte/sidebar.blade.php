        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @if(Auth::user())
            ...
            <li class="nav-item has-treeview {{ ( request()->is('graficos/*') ) ? 'menu-open' : '' }}">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                <a href="{{route('graficos.aportes')}}" class="nav-link {{ ( request()->is('graficos/aportes') ) ? 'active' : '' }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Aportes </p>
                  </a>
                </li>
                ...
                <li class="nav-item">
                  <a href="{{route('graficos.aportes.anio')}}" class="nav-link {{ ( request()->is('graficos/aportes/anio') ) ? 'active' : '' }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Aportes 2</p>
                  </a>
                </li>
