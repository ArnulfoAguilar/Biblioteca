  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <!--biblioteca-->
        @if (Auth::user()->rol->id == '1' || Auth::user()->rol->id == '2' || Auth::user()->rol->id == '3' ||
        Auth::user()->rol->id == '4')
        <li class="nav-item has-treeview {{ ( request()->is('biblioteca/*') ) ? 'menu-open' : '' }}">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{ route('buscar.disponible') }}"
                class="nav-link {{ ( request()->is('biblioteca/busqueda/*') ) ? 'active' : '' }}">
            ...
            <li class="nav-item">
              <a href="{{route ('prestamos')}}"
                class="nav-link {{ ( request()->is('biblioteca/prestamo') ) ? 'active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
            ...
            <li class="nav-item">
              <a href="{{route ('prestamos.v2')}}"
                class="nav-link {{ ( request()->is('biblioteca/prestamos') ) ? 'active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
            ...
            <li class="nav-item">
              <a href="{{route ('index.misPrestamos')}}"
                class="nav-link {{( request()->is('bibioteca/misPrestamos') ) ? 'active' : ''}}">
                <i class="far fa-circle nav-icon"></i>
                <p>Mis Préstamos</p>
              </a>
            </li>
        ...
        <ul class="nav nav-treeview">
          <li class="nav-item">
            <a href="{{ route('biblioteca') }}"
              class="nav-link {{ ( request()->is('inventario/bibliotecas') ) ? 'active' : '' }}">
              <i class="far fa-circle nav-icon"></i>
              <p>Bibliotecas</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('inventario.estantes') }}"
              class="nav-link {{ ( request()->is('inventario/estantes') ) ? 'active' : '' }}">
              <i class="far fa-circle nav-icon"></i>
              <p>Estantes</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('busqueda') }}"
              class="nav-link {{ ( request()->is('inventario/ingreso/libro') ) ? 'active' : '' }}">
              <i class="far fa-circle nav-icon"></i>
              <p>Ingreso de libro</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('lista.ejemplares') }}"
              class="nav-link {{ ( request()->is('inventario/lista/ejemplares') ) ? 'active' : '' }}">
              <i class="far fa-circle nav-icon"></i>
      ...
      <li class="nav-item has-treeview {{ ( request()->is('administracion/*') ) ? 'menu-open' : '' }}">
        ...
        <ul class="nav nav-treeview">
          <li class="nav-item">
            <a href="{{route('roles')}}"
              class="nav-link {{ ( request()->is('administracion/roles') ) ? 'active' : '' }}">
              <i class="far fa-circle nav-icon"></i>
              <p>Lista de roles</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="{{route('asignar.roles')}}"
              class="nav-link {{ ( request()->is('administracion/asignar/roles') ) ? 'active' : '' }}">
              <i class="far fa-circle nav-icon"></i>
              <p>Asignar rol</p>
            </a>
          </li>
